...
- 📖 **多帳本管理** - 支援日常、旅遊等不同帳本，各自獨立結算（可拖曳排序）
- 📱 **手機優化體驗** - 針對手機優化 UI 尺寸，視野更廣，全螢幕沉浸式
- 🔙 **智能返回鍵** - Android 返回鍵優先關閉彈窗，再返回首頁，最後退出
- 📳 **觸覺回饋** - 拖曳帳本時提供震動回饋，互動更有感
...
4. **帳本拖曳互動升級** 🎯
   - 震動回饋：開始拖曳、移動、放置成功
   - 精緻動畫：放大、旋轉、漂浮、脈動
   - 多平台支援：Capacitor + Web Vibration API
